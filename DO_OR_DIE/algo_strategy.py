...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def left_right(self, game_state):
        ...
        game_state.attempt_spawn(DEMOLISHER, demo_locs[0], 2)
    ...
    def find_location(self, game_state):
        ...
        scout_spawn_location_options =[[14,0],[15,1], [16,2], [17,3], [18,4], [19,5], [20,6], [21,7],[22,8],[23,9],[24,10]]
    ...
    def layer1(self, game_state):
        ...
        unit_locations = [[TURRET, 13,13], [TURRET, 4,13],[TURRET, 5,13],[TURRET, 22,13], [TURRET, 23,13], [TURRET, 14,13], [SUPPORT, 5, 10], [SUPPORT, 6,9], [SUPPORT, 6, 10], [SUPPORT, 7, 9], [SUPPORT, 7, 8], [SUPPORT, 9, 6], [SUPPORT, 11, 3], [SUPPORT, 9, 8], [SUPPORT, 11, 6]]
        for unit in unit_locations:
            x, y = unit[1:]
            if game_state.turn_number > 0 and len(game_state.game_map[x, y]) == 0 and unit[0] == TURRET:
